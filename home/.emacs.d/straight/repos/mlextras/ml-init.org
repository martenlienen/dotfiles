...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set font for high DPI displays
  (internal-set-lisp-face-attribute
   'default :font (font-spec :family "Fira Code"
                             :size 12.0 :dpi 144))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package tex
    ;; AUCTeX now needs an explicit configuration step to create tex-site.el from
    ;; tex-site.el.in, so I muddled together this recipe
    :straight '(auctex
                :type git
