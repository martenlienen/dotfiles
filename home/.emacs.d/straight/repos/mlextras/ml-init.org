...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package shackle
    ...
    :custom ((shackle-rules '(("^\\*helpful" . (:regexp t :popup t :align right :size 70))
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package python
    ...
    (add-hook 'python-mode-hook #'ml-enable-local-pyenv)
    ...
    (add-hook 'python-mode-hook #'hack-local-variables))
