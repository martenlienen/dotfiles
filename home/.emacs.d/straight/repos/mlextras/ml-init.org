...
#+BEGIN_SRC emacs-lisp
  ...
  %?" :jump-to-captured t :prepend t)))
    ...
    (defun ml/find-note ()
      ...
      (let ((default-directory org-directory))
        (project-find-file)))  (require 'org-crypt)
  ...
  (use-package org-ql
    ...
    :after org
    :config
    ;; Load dynamic block support in org-mode
...
#+BEGIN_SRC emacs-lisp
  (use-package jinx
    ...
    ;; Only spell check comments and strings in TOML
    (add-to-list 'jinx-include-faces '(toml-mode . conf-mode)))
#+END_SRC
