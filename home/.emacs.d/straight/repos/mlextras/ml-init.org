...
#+BEGIN_SRC emacs-lisp
  (use-package cqql
    :straight (cqql :local-repo "mlextras")
...
#+BEGIN_SRC emacs-lisp
  (use-package tmp-buffer
    :straight (tmp-buffer :local-repo "mlextras")
    :bind ("C-c n" . tmp-buffer))

  (use-package window-extras
    :straight (window-extras :local-repo "mlextras")
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package solarized-theme
    :straight t
    :config (load-theme 'solarized-zenburn t))
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package cqql-deadgrep
    :straight (cqql-deadgrep :local-repo "mlextras")
    :after deadgrep
    :bind (("S-<f9>" . cqql-deadgrep-here)
           ...
           ("g" . cqql-deadgrep-file-type-glob)))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package lsp-julia
    :straight (lsp-julia :fetcher github :repo "non-Jedi/lsp-julia" :files (:defaults "languageserver"))
    :init
